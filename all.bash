...
# 定义路径参数
SRC_ROOT="/inspire/hdd/global_user/konghanlin-253108540238/user_cache/datasets/tmp_nav_catch_tiny" #源数据根目录路径
# DST_ROOT="/inspire/hdd/global_user/konghanlin-253108540238/user_cache/datasets/tmp_ori_nav_catch_put" #目标数据根目录路径
DST_ROOT=$SRC_ROOT
FINAL_ROOT="/inspire/hdd/global_user/konghanlin-253108540238/user_cache/lerobot/dzb/our_data_tiny_test" #最终输出根目录路径
